...
//import com.dscfgos.api.model.constants.ItemData;
//import com.dscfgos.api.model.constants.ItemListData;
//import com.dscfgos.api.model.constants.Locale;
//import com.dscfgos.api.model.constants.MasteryData;
...
//import com.dscfgos.api.model.dtos.featured_games.FeaturedGames;
...
//import com.dscfgos.api.model.dtos.match_list.MatchList;
//import com.dscfgos.api.model.dtos.static_data.Champion;
//import com.dscfgos.api.model.dtos.static_data.Item;
//import com.dscfgos.api.model.dtos.static_data.ItemList;
//import com.dscfgos.api.model.dtos.static_data.LanguageStrings;
//import com.dscfgos.api.model.dtos.static_data.MapData;
//import com.dscfgos.api.model.dtos.static_data.Mastery;
...
//import com.dscfgos.api.model.dtos.stats.PlayerStatsSummaryList;
...
//import com.dscfgos.api.model.endpoints.methods.championmastery.GetChampionMasteryScore;
//import com.dscfgos.api.model.endpoints.methods.championmastery.GetTopChampionMasteries;
//import com.dscfgos.api.model.endpoints.methods.current_game.GetCurrentGameInfo;
//import com.dscfgos.api.model.endpoints.methods.featured_games.GetFeaturedGames;
//import com.dscfgos.api.model.endpoints.methods.game.GetRecentGames;
//import com.dscfgos.api.model.endpoints.methods.league.GetChallengerLeague;
//import com.dscfgos.api.model.endpoints.methods.league.GetLeagueBySummoners;
//import com.dscfgos.api.model.endpoints.methods.league.GetLeagueEntryBySummoners;
//import com.dscfgos.api.model.endpoints.methods.league.GetMasterLeague;
//import com.dscfgos.api.model.endpoints.methods.match.GetMatch;
//import com.dscfgos.api.model.endpoints.methods.match.GetMatchForTournament;
//import com.dscfgos.api.model.endpoints.methods.match.GetMatchesByTournament;
//import com.dscfgos.api.model.endpoints.methods.match_list.GetMatchList;
//import com.dscfgos.api.model.endpoints.methods.static_data.GetDataChampion;
//import com.dscfgos.api.model.endpoints.methods.static_data.GetDataChampionList;
...
//import com.dscfgos.api.model.endpoints.methods.static_data.GetDataRune;
...
//import com.dscfgos.api.model.endpoints.methods.static_data.GetDataSummonerSpellList;
//import com.dscfgos.api.model.endpoints.methods.static_data.GetDataVersions;
//import com.dscfgos.api.model.endpoints.methods.stats.GetPlayerStatsSummary;
...
//import com.dscfgos.api.model.endpoints.methods.summoner.GetSummonerMap;
...
//import com.dscfgos.api.model.endpoints.methods.tournament.CreateTournamentCodes;
...
//import com.dscfgos.api.model.endpoints.methods.v3.summoner.GetSummonerByName;
//import com.dscfgos.api.model.endpoints.methods.v3.summoner.GetSummonerById;
...
//	 * @see Champion
//	 */
//	public com.dscfgos.api.model.dtos.champion.Champion getChampionById(Region region, int id) throws RiotApiException {
//		Objects.requireNonNull(region);
...
//	 * @throws RiotApiException
//	 *             If the API returns an error or unparsable result
//	 * @see com.dscfgos.api.model.dtos.static_data.Champion
//	 */
...
//	 */
//	public com.dscfgos.api.model.dtos.static_data.ChampionList getDataChampionList(Region region, Locale locale, String version, boolean dataById,
...
//	 * @see net.rithms.riot.api.endpoints.static_data.dto.ChampionList
//	 */
//	public com.dscfgos.api.model.dtos.static_data.ChampionList getDataChampionList(Region region) throws RiotApiException 
//	{
//		Objects.requireNonNull(region);
...
//		ApiMethod method = new GetSummonerByName(getConfig(), region, Convert.joinString(",", summonerName));
//		return endpointManager.callMethodAndReturnDto(method);
//	}
//
//	/**
...
//		Objects.requireNonNull(region);
//		Objects.requireNonNull(summonerIds);
//		ApiMethod method = new GetSummonerById(getConfig(), region, Convert.joinString(",", summonerIds));
//		return endpointManager.callMethodAndReturnDto(method);
//	}
//
//	/**
