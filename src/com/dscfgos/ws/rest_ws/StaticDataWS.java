...
public class StaticDataWS 
{
	...
	@Path("/champ")
	@Produces(MediaType.APPLICATION_JSON)
	public String getChampionById(@QueryParam("id") int id, @QueryParam("locale") String locale, @QueryParam("region") String region)
	{
		return gson.toJson(StaticDataManager.getBasicChampionById(id, Region.getRegionById(region), Locale.getById(locale), ""));
	}
}
